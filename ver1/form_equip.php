	...
	<div id="fh5co-blog" class="fh5co-bg-section">
		<div class="container">
			...
			<img class="img-responsive" src="admin/picture/equip/<?=$data['equip_pic']?>" alt="" style="width:500px; height:500px;">
				...
				<div class="col-md-6">
					<form method="post" action="insert_order_equip.php" enctype="multipart/form-data">
						<div><label>วันที่ยืม : </label><input type="date" name="date"></div>
						<div><label>สถานที่ยืม : </label><input type="text" name="place"></div>
						<div><label>จำนวน : </label><input type="text" name="num"></div>
